...
public class App { // Defines a class named App.
    ...
    public static void main(String[] args) { // The main method, the entry point of the application.
        ...
        asteriskLogger.error("Something went wrong"); // Calls the error method of the asteriskLogger instance with the error message "Something went wrong".
        ...
        spacedLogger.error("Something went wrong"); // Calls the error method of the spacedLogger instance with the error message "Something went wrong".
    }
}
